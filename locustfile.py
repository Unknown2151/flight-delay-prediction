...
Features:
    ...
    - Real and edge-case flight data
...
# Test data - Real Amadeus test environment flights
KNOWN_FLIGHTS: List[Dict[str, str]] = [
    {"carrierCode": "IB", "flightNumber": "532"},
    {"carrierCode": "IB", "flightNumber": "534"},
    {"carrierCode": "IB", "flightNumber": "536"},
    {"carrierCode": "IB", "flightNumber": "1020"},
    {"carrierCode": "BA", "flightNumber": "490"},
    {"carrierCode": "BA", "flightNumber": "480"},
    {"carrierCode": "BA", "flightNumber": "476"},
    {"carrierCode": "LH", "flightNumber": "400"},
    {"carrierCode": "LH", "flightNumber": "1800"},
    {"carrierCode": "LH", "flightNumber": "1806"},
    {"carrierCode": "AA", "flightNumber": "1"},
    {"carrierCode": "AA", "flightNumber": "100"},
    {"carrierCode": "DL", "flightNumber": "1"},
    {"carrierCode": "UA", "flightNumber": "1"},
    {"carrierCode": "AF", "flightNumber": "1"},
    {"carrierCode": "AZ", "flightNumber": "610"},
]
...
class CacheOptimizationUser(FlightApiBaseSimulation):
    ...
    def __init__(self, environment):
        ...
        # Select 5 random flights to repeatedly query
        self.favorite_flights = random.sample(KNOWN_FLIGHTS, 5)
        self.flight_index = 0
...
class CircuitBreakerTestUser(FlightApiBaseSimulation):
    ...
    def predict_with_potential_fallback(self) -> None:
        ...
        with self.client.post(
            ...
            catch_response=True,
            timeout=60  # Increased timeout for potential external delays
        ) as response:
            if response.status_code == 200:
                success_tracker.record_request(True)
                resp_data = response.json()
...
def on_request(request_type, name, response_time, response_length, success, **kwargs) -> None:
    """
    Called after each request - could be used for detailed logging.
